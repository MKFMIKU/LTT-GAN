...
class GFPGANCX2Model(BaseModel):
    ...
    def optimize_parameters(self, current_iter):
        ...
        if (current_iter % self.net_d_iters == 0 and current_iter > self.net_d_init_iters):
            ...
            l_g_cx = (pixel_contextual_loss(self.output, self.gt, window_size=32) + \
                    pixel_contextual_loss(self.output, self.gt, window_size=64)) / 2
            l_g_total += l_g_cx
