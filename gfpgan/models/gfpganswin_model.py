...
class GFPGANSWINModel(BaseModel):
    def __init__(self, opt):
        super(GFPGANSWINModel, self).__init__(opt)
        self.idx = 0
    ...
    def optimize_parameters(self, current_iter):
        ...
        if (current_iter % self.net_d_iters == 0 and current_iter > self.net_d_init_iters):
            ...
            # pixel contextual loss
            loss_dict[f'l_g_context'] = pixel_contextual_loss(out_rgbs[-1], pyramid_gt[-1]) * 0.1
