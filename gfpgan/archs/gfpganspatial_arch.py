...
class StyleGAN2GeneratorSFTSPA(StyleGAN2Generator):
    """StyleGAN2 Generator.
    ...
    def __init__(self,
                 ...
                 narrow=1,
                 sft_half=False):
        super(StyleGAN2GeneratorSFTSPA, self).__init__(
            out_size,
        ...
        self.pe = PE2dStart(512, 4, 4, scale=1.0)
...
class GFPGANSpatial(nn.Module):
    ...
    def __init__(
        ...
        super(GFPGANSpatial, self).__init__()
        ...
        self.stylegan_decoder = StyleGAN2GeneratorSFTSPA(
            out_size=out_size,
            num_style_feat=num_style_feat,
            num_mlp=num_mlp,
            channel_multiplier=channel_multiplier,
...
class PE2dStart(nn.Module):
    def __init__(self, channel, height, width, scale=1.0):
        ...
        self.pe = torch.zeros(channel, height, width)
