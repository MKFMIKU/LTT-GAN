...
class FFHQBlur2Dataset(data.Dataset):

    def __init__(self, opt):
        super(FFHQBlur2Dataset, self).__init__()
        self.opt = opt
        ...
        self.deformation = iaa.ElasticTransformation(alpha=opt['elastic_alpha'], sigma=opt['elastic_sigma_range'])
